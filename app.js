...
const iceCreams = [
  {
    ...
    name: `Dark Chocolate & Nordic Berry`,
    brand: 'Nuii',
    image: 'https://www.nuiiicecream.co.uk/media/1085/nordic-berries.png',
    url: 'https://www.nuiiicecream.co.uk/the-flavours/dark-chocolate-nordic-berry/',
    date: new Date(2020, 05, 26),
    categories: ['OG'],
    description: `A fresh take on a classic combination, indulgent chocolate ice cream is folded in with generous lashings of Nordic blueberry sauce. For that extra touch, it is topped with dark chocolate, cocoa nibs and handpicked blueberries.`,
    tasting_notes: `Nice crunchy chocolate outer shell with a nice hint of sharp acidic blueberry.`,
    rating: 3,
  },{
    name: 'Poppin Popcorn',
    brand: `Ben & Jerry's`,
    ...
    name: `Cookies & Idaho Valley Mint`,
    brand: 'Nuii',
    image: 'https://www.nuiiicecream.co.uk/media/1019/mint-cookies.png',
    url: 'https://www.nuiiicecream.co.uk/the-flavours/cookies-idaho-valley-mint/',
    date: new Date(2020, 06, 07),
    categories: ['OG'],
    description: `Each bite delivers a smooth & refreshing mint flavoured ice cream combined with delicious chocolate cookies and covered with milk chocolate and even more indulgent cookie pieces. A trail through the valleys will take your breath away.`,
    tasting_notes: `Decent ice cream surrounded in a refreshing mint flavoured chocolate shell.`,
    rating: 4,
  },{
    ...
    name: `Almond and Chocolate Covered Ice Cream Bar`,
    brand: 'Gelatelli',
    image: 'https://nie.cat-ret.assets.lidl/catalog4media/nie/article/200003/gallery/preview/lg/200003.jpg',
    url: 'https://www.lidl-ni.co.uk/en/p/fairtrade-products/gelatelli-classic-ice-almond/p26530',
    date: new Date(2020, 07, 12),
    categories: ['OG'],
    description: `Bourbon vanilla ice cream in milk choclate with almond pieces.`,
    tasting_notes: `Excellent thick chocolate with big almond chunks covering on a very vanillary smooth ice cream.`,
    rating: 5,
  },{
    name: `Double Raspberry Ice Cream Bar`,
    brand: 'Magnum',
    image: 'https://asset-americas.unileversolutions.com/content/dam/unilever/magnum/united_states_of_america/pack_shot/077567271051-1690158-png.png.ulenscale.400x400.png',
    url: 'https://www.magnumicecream.com/us/en/flavors/icecream-bars/double-raspberry-ice-cream-bar.html',
    date: new Date(2020, 07, 20),
    categories: ['OG'],
    description: `Berry bliss and featuring two layers of Belgian chocolate. Delectable Double Raspberry Magnum Ice Cream bars are a luxurious treat like no other. The fresh taste of wild raspberry ice cream, dipped in a gooey chocolatey layer, paired delightfully with a tart, luscious raspberry sauce and covered in a cracking milk chocolate shell pampers your taste buds.`,
    tasting_notes: `The double chocolate doesn't work, both layers are too thin. Nothing special and a bit sickly`,
    rating: 2,
  },{
    name: `Caramel Pecan`,
    brand: 'Judes',
    ...
    name: `Clotted Cream Flavoured Ice Cream`,
